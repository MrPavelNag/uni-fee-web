...
def save_chart_data_json(pool_chart_data: dict[str, dict], path: str) -> None:
    ...
    for k, v in pool_chart_data.items():
        out[k] = {
            ...
            "strict_compare_exact_active_fees": v.get("strict_compare_exact_active_fees") or [],
            "strict_compare_exact_fees": v.get("strict_compare_exact_fees") or [],
            "strict_compare_exact_sanity_fees": v.get("strict_compare_exact_sanity_fees") or [],
            "strict_compare_exact_active_sanity_fees": v.get("strict_compare_exact_active_sanity_fees") or [],
